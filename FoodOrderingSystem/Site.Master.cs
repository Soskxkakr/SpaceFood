            ...
            if (currentCart.Get_Number_Of_Products() != 0)
            {
                foreach (Product prod in currentCart.products)
                {
                    htmlStr += 
                        ...
                        "   <div class='img' style='background-image: url(assets/" + prod.category + "s" + "/" + prod.image + ");'></div>" + 
                        "   <div class='text pl-3'>" + 
                        "       <h4>" + prod.name + "</h4>" +
                        "       <p class='mb-0'>" +
                        "           <p class='price'>RM " + prod.price + "</p><span class='quantity ml-3'>Quantity: " + prod.quantity + "</span>" +
                        "       </p>" +
                        "   </div>" +
                        "</div>";
                }
