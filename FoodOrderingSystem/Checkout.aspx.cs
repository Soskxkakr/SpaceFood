    ...
    public partial class Checkout : System.Web.UI.Page
    {
        ...
        protected void PlaceOrder_OnClick(object sender, EventArgs e)
        {
            ...
            foreach (Product prod in listOfProducts)
            {
                ...
                {
                    conn.Open();
                    string query = "INSERT INTO TblDeliver (OrderId, UserId, ProductId, ProductName, Quantity, Status, Date, Total)" +
                        "VALUES (@OrderId, @UserId, @ProductId, @ProductName, @Quantity, @Status, @Date, @Total)";
